...
def print_examples():
    ...
    logger.info("  python packages\\gphotos-321sync-media-scanner\\tests\\e2e\\generate_test_data.py --output-dir C:\\temp\\e2e_test_data")
    logger.info("")
    logger.info("Generate custom number of files:")
    logger.info("  python packages\\gphotos-321sync-media-scanner\\tests\\e2e\\generate_test_data.py --output-dir C:\\temp\\e2e_test_data --total-files 5000")
    logger.info("")
    
    logger.info("2. RUN SCANNER AND ANALYZE")
    logger.info("-" * 80)
    logger.info("Basic scan with analysis:")
    logger.info("  python packages\\gphotos-321sync-media-scanner\\tests\\e2e\\run_scanner_and_analyze.py --test-data-dir C:\\temp\\e2e_test_data")
    logger.info("")
    logger.info("Scan with custom parameters:")
    logger.info("  python packages\\gphotos-321sync-media-scanner\\tests\\e2e\\run_scanner_and_analyze.py `")
